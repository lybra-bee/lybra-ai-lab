...
![Киберпанк-город]({{ site.baseurl }}/_experiments/images/cyberpunk-city.jpg)
...
![Аниме портрет]({{ site.baseurl }}/_experiments/images/anime-portrait.jpg)
...
![Космическая станция]({{ site.baseurl }}/_experiments/images/sci-fi-station.jpg)
...
![Реалистичный пейзаж]({{ site.baseurl }}/_experiments/images/mountain-landscape.jpg)
...
![Мониторинг системы]({{ site.baseurl }}/_experiments/images/system-monitor.jpg)
